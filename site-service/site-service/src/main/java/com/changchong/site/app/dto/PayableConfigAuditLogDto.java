...
public class PayableConfigAuditLogDto implements Serializable {

	private static final long serialVersionUID = 1L;
	
	private Integer id;
	private Integer config_id; // 配置表主键
	private String audit_reason; // 审核结果
	private Byte status; // 审核状态 1-未审核 2-初审通过 3-初审未通过 4-复审通过 5-复审未通过 6-删除未审核 7-删除初审通过 8-删除初审未通过 9-删除复审通过 10-删除复审未通过
