...
public final class Base64 {
    ...
    public static String encode(byte[] binaryData) {
        ...
        if(encodedData.length<12){
        	returnString = getRandomString(12-encodedData.length);
        }
        return new String(encodedData)+returnString;
    }
    public static String getRandomString(int length) { //length表示生成字符串的长度
        String base = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOKQRSTUVWXYZ0123456789";   
    ...
    public static void main(String[] args) {
       	try {	
       			logger.info(encode("123".getBytes()));
    		} catch (Exception e) {
