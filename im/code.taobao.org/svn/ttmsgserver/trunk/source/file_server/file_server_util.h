...
typedef struct transfer_task_t{
	...
	string      file_id; // uuid_unparse char[37], added by george on Dec 7th,2015
 ...
 //       upload_packages_lock = PTHREAD_RWLOCK_INITIALIZER;
        ...
        fp = NULL;
		from_conn = NULL;  //set null by default, by george jiang July 20th,2015
		to_conn = NULL;   //set null by default
        transfered_size = 0;
        file_head = NULL;
        self_destroy = false;
        worker = (pthread_t)0;
