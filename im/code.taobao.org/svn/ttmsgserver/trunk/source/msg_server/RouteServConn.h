...
private:
	...
	void _HandleOnlineUsersResponse(CImPdu* pPdu);
	void _HandleSyncUserNotify(CImPdu* pPdu);
	void _HandleSyncDepartmentNotify(CImPdu* pPdu);
	void _HandleSyncPositionNotify(CImPdu* pPdu);
	void _HandleSyncUserDetailsNotify(CImPdu* pPdu);
	void _HandleSyncUserDutyNotify(CImPdu* pPdu);
	void _HandleSyncDepartUserRemoveNotify(CImPdu* pPdu);
	void _HandleSyncPasswordNotify(CImPdu* pPdu);
	void _HandleSyncMailGroupChangeNameNotify(CImPdu* pPdu);
	void _HandleSyncGroupTransferLeaderNotify(CImPdu* pPdu);
	void _HandleSyncMailGroupCreationNotify(CImPdu* pPdu);
	void _HandleSyncStaffNotify(CImPdu* pPdu);
	void _HandleSyncCompanyNotify(CImPdu* pPdu);
	void _HandleUserMomentNotify(CImPdu* pPdu);
