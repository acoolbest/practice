...
public:
	...
	void HandleClientGroupTransferLeaderRequest(CImPdu* pPdu, CMsgConn* pFromConn);
	void HandleGroupTransferLeaderResponse(CImPdu* pPdu);
	void HandleGroupTransferLeaderBroadcast(CImPdu *pPdu);
