...
//{
//	//log("preparing to get command id: %u......................", pPdu->GetCommandId());
...
//	uint32_t task_create_time = msg.task_create_time();
//	uint32_t valid_period = msg.valid_period();
...
//        task_id: %s, trans_mode: %u, task_create_time: %u, valid_period: %u. file_id: %s", result, from_id, to_id,
//        file_name.c_str(), task_id.c_str(), trans_mode,task_create_time, valid_period, file_id.c_str());
//
...
//	msg2.set_task_create_time(task_create_time);
//	msg2.set_valid_period(valid_period);
//	msg2.set_file_id(file_id); //added on Dec 7th,2015
...
//
//		log("file server: %s:%d", ip_addr_tmp.ip().c_str(), ip_addr_tmp.port());
//
//    }
//    CImPdu pdu;
//    pdu.SetPBMsg(&msg2);
