...
public:
   // virtual bool doLogin(const std::string& strName, const std::string& strPass, IM::BaseDefine::UserInfo& user) = 0;
	virtual bool doLogin(const std::string& strName, const std::string& strPass, uint32_t& unUserId, int32_t& nStatus, uint32_t unIsActivated, std::string& strClientIp) = 0;
};
