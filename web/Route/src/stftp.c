...
Maintainer: wenhao v1.1 2011-10-28
			1. 添加注释
			2. 优化代码
			意见:ls显示当前目录文件时,能指示出当前文件大小

Maintainer: wenhao v1.2 2011-11-4
			1. 添加清屏功能
			2. 修改上传部分BUG

Maintainer: wenhao v1.3 2012-03-06
			1. 修复传大文件失败的问题
			2. 帮助打印中添加清屏标示
*********************************************/
#include <stdio.h>
...
static int SetEn = 0; //服务器IP设置使能标志
static int sockfd = 0; //UDP文件描述符
static int flag_stftp = 0;
//帮助文档打印消息
char *help= "*********************************************************************************\n"\
