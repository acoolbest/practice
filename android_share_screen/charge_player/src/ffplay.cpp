...
static int packet_queue_put_private(PacketQueue *q, AVPacket *pkt)
{
    ...
    pkt1 = (MyAVPacketList *)av_malloc((size_t)sizeof(MyAVPacketList));
    if (!pkt1)
        return -1;
    pkt1->pkt = *pkt;
    pkt1->next = NULL;
...
int main(int argc, char **argv)
{
    ...
    //parse_options(NULL, argc, argv, options, opt_input_file); /* Set input url, set nobuffer*/
	opt_input_file(NULL,"rtmp://localhost/hls/test");
